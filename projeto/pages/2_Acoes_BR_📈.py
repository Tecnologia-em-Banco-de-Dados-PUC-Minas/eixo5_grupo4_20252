...
from projeto.etl.acoes import obter_melhores_e_piores_acoes, baixar_historico_acoes
...
historico_path = os.path.join(project_root, 'results', 'historico_acoes.csv')
