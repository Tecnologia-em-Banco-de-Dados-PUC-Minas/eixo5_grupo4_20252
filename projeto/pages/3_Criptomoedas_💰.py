...
from projeto.etl.criptomoedas import obter_melhores_e_piores_cripto, baixar_historico_cripto, get_usdbrl_rate
...
historico_path = os.path.join(project_root, 'results', 'historico_criptomoedas.csv')
